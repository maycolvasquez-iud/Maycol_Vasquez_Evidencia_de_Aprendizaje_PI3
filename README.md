...
Este repositorio contiene la Evidencia de Aprendizaje 1, desarrollada como parte del curso Proyecto Integrado III - Analítica de Datos.

El notebook presenta un flujo de trabajo enfocado en el análisis de datos, que puede incluir:
